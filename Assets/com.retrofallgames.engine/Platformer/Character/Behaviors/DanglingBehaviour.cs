...
namespace RFG.Platformer
{
  ...
  public class DanglingBehaviour : MonoBehaviour
  {
    ...
    private void Update()
    {
      ...
      RaycastHit2D hit = RFG.Core.Physics2D.RayCast(raycastOrigin, -_transform.up, _settings.DanglingRaycastLength, _controller.PlatformMask | _controller.OneWayPlatformMask | _controller.OneWayMovingPlatformMask, Color.gray, true);
