  ...
  namespace Platformer
  {
    ...
    public class StairsAbility : MonoBehaviour, IAbility
    {
      ...
      private void CheckIfStairsAhead()
      {
        ...
        RaycastHit2D hit = RFG.Core.Physics2D.RayCast(_raycastOrigin, _raycastDirection, _settings.StairsAheadDetectionRaycastLength, _controller.StairsMask, Color.yellow, true);
      ...
      private void CheckIfStairsBelow()
      {
        ...
        RaycastHit2D hit = RFG.Core.Physics2D.RayCast(_raycastOrigin, -transform.up, _settings.StairsBelowDetectionRaycastLength, _controller.StairsMask, Color.yellow, true);
