...
namespace RFG.Platformer
{
  public static class AIAjentEx
  {
    ...
    public static bool IsDangling(this AIAjent ctx)
    {
      ...
      RaycastHit2D hit = RFG.Core.Physics2D.RayCast(raycastOrigin, -ctx.transform.up, _settings.DanglingRaycastLength, ctx.controller.PlatformMask | ctx.controller.OneWayPlatformMask | ctx.controller.OneWayMovingPlatformMask, Color.gray, true);
