...
namespace RFG
{
  namespace Platformer
  {
    ...
    public class AIJumpBehaviour : MonoBehaviour
    {
      ...
      //   }
      //   if (ctx.character.CurrentStateType == typeof(AIJumpingLeftState) || ctx.character.CurrentStateType == typeof(AIJumpingRightState))
      //   {
      //     JumpStart(ctx);
      //   }
      // }
      ...
      //   if (ctx.character.CurrentStateType == typeof(AIJumpingLeftState) && ctx.character.Controller.State.IsFacingRight)
      //   {
      //     ctx.character.Controller.Flip();
      //   }
      //   else if (ctx.character.CurrentStateType == typeof(AIJumpingRightState) && !ctx.character.Controller.State.IsFacingRight)
      //   {
      //     ctx.character.Controller.Flip();
      //   }
      ...
      //   // ctx.character.ChangeState(typeof(JumpingState));
      ...
      //   ctx.character.RestorePreviousState();
      // }
